...
SPLIT_NOTES: dict[str, str] = {
    ...
    "mc.world.level.chunk.access": (
        ...
        "blockEntities map (setBlockEntity/getBlockEntity) defers with the "
        "block-entity unit, and setBlockEntityNbt's containsKey guard is "
        "omitted (chunk-storage #216). BulkSectionAccess is a chunk.access "
