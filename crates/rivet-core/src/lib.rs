...
//!
//! STUB(net.minecraft) — `CrashReport`/`ReportedException` and `ChatFormatting`
//! were moved here from rivet-nbt/rivet-text (decision 7754455). The real ports
//! live in rivet-server (CrashReport) / rivet-text (ChatFormatting); the minimal
