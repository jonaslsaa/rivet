...
//  MC 26.2, protocol 776, world 4903).
// Source capture sha256 e78a673617a1eefc; provenance linked to data/synchronized_registries.manifest.json.
...
pub static SYNCHRONIZED_REGISTRIES: &[(&str, &[&str])] = &[
    (
