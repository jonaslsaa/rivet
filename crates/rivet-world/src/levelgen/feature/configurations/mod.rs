...
//! `LayerConfiguration.java`, `SpikeConfiguration.java`, and
//! `ReplaceSphereConfiguration.java`, `DiskConfiguration.java`,
//! `SpeleothemConfiguration.java`, `DeltaFeatureConfiguration.java`,
//! `ColumnFeatureConfiguration.java`, `SculkPatchConfiguration.java`,
//! `SimpleBlockConfiguration.java`, `NetherForestVegetationConfig.java` (which
//! depends on the `BlockPileConfiguration` cross-unit stub owned by the
//! pending `mc.world.level.levelgen.feature.configurations.blockpile` unit),
//! and `HugeMushroomFeatureConfiguration.java`, each owned by its own manifest
//! unit under this package. They implement the `FeatureConfiguration` trait
//! defined here.
...
pub use block_pile_configuration::BlockPileConfiguration;
...
pub use end_spike_configuration::{EndSpike, EndSpikeConfiguration};
...
pub use spring_configuration::{FluidState, SpringConfiguration};
pub use template_feature_configuration::{TemplateEntry, TemplateFeatureConfiguration};
