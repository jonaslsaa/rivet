...
//!      `--text`. The `spline/`, `seq/`, and `biome-temperature/` value-leaf
//!      goldens are regenerated by `scripts/run_spline_probe.sh` /
//!      `scripts/run_seq_probe.sh` / `scripts/run_biome_temperature_probe.sh`
